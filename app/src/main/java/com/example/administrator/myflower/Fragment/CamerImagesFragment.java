 ...
 */
public class CamerImagesFragment extends Fragment{
...
//            }
        ...
        RecyclerView index_recycleView = (RecyclerView) view.findViewById(R.id.cammer_recycleView);
...
//        设置网格布局
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_camer, container, false);
