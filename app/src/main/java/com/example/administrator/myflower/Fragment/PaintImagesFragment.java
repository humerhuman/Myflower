 ...
 */
public class PaintImagesFragment extends Fragment{
    private View view;
...
//            }
        ...
        RecyclerView index_recycleView = (RecyclerView) view.findViewById(R.id.paint_recycleView);
