 ...
 */
public class FashionImagesFragment extends Fragment{
    private View view;
...
//            }
        ...
        RecyclerView index_recycleView = (RecyclerView) view.findViewById(R.id.fashion_recycleView);
