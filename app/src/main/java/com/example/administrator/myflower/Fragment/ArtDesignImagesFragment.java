 ...
 */
public class ArtDesignImagesFragment extends Fragment {
    private View view;
...
//            }
        ...
        RecyclerView index_recycleView = (RecyclerView) view.findViewById(R.id.design_recycleView);
