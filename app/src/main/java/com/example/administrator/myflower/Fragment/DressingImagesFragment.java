 ...
 */
public class DressingImagesFragment extends Fragment{
    private View view;
...
//            }
        ...
        RecyclerView index_recycleView = (RecyclerView) view.findViewById(R.id.dressing_recycleView);
...
//        设置网格布局
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_dressing, container, false);
