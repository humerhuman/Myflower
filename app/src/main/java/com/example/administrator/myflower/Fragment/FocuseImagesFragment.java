 ...
 */
public class FocuseImagesFragment extends Fragment{
...
//            }
        ...
        RecyclerView index_recycleView = (RecyclerView) view.findViewById(R.id.focuse_recycleView);
...
//        设置网格布局
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle
        ...
        view = inflater.inflate(R.layout.fragment_focuse, container, false);
        initDataAndView();
